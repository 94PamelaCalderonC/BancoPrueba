 ...
 * @author I7
 */
public abstract class CuentaBancariaAbstracta {
   ...
   private double monto;
    ...
    public CuentaBancariaAbstracta(int clienteid, String nombre, String apellido, String tipocuenta, double monto) {
